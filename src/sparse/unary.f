...
c-----------------------------------------------------------------------
      subroutine csort_cmplx (n,a,ja,ia,iwork,values) 
...
c 
         call ivperm (nnz, ja(ifirst), iwork) 
         if (values) call dvperm_cmplx(nnz, a(ifirst), iwork) 
c
c reshift the pointers of the original matrix back.
c 
      do 8 i=n,1,-1
...
c-----------------------------------------------------------------------
      subroutine dvperm_cmplx (n, x, perm) 
      use precisions, only: cwp
      integer n, perm(n) 
      complex(cwp) x(n)
c-----------------------------------------------------------------------
